...
import { LazyImage, AnimatedSection } from '@/components/common';
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
              {stats.map((stat, index) => (
                <AnimatedSection key={index} delay={index * 100} type="scale">
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {BRANDS_DATA.slice(0, 8).map((brand, index) => (
                <AnimatedSection key={brand.id} delay={index * 50} type="scale">
                  <Link
                    to={`/brands/${brand.id}`}
                  ...
                  >
                    <div className="aspect-square mb-4 flex items-center justify-center">
                      <LazyImage
                        ...
                        placeholderClassName="group-hover:scale-105 transition-transform"
                      />
                    </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {MODELS_DATA.slice(0, 6).map((model, index) => {
                const brand = BRANDS_DATA.find(b => b.id === model.brandId);
                return (
                  <AnimatedSection key={model.id} delay={index * 80} type="scale">
                    <Card 
